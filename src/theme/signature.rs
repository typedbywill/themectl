...
use crate::theme::manifest::{ThemeManifest, Signature};
...
pub fn compute_theme_hash(theme_dir: &Path) -> Result<[u8; 32]> {
    ...
    for file_path in files {
        ...
        // Wait, does lockfile change after install? Usually not, but lockfile is generated on export.
...
mod tests {
    use super::*;
    use crate::theme::manifest::{DesktopEnvironment, ThemeManifest};
